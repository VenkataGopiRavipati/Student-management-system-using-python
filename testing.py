...
class member:
    ...
    def saveindb(self):
        ...
        if (self.pass1.get() == self.pass2.get()):
            if self.ans == self.otp:
                insert = ''' insert into user (fname,lname,email ,phnno,pass ) values
                          (?,?,?,?,?) '''
                c.execute(insert, [(self.fname.get()), (self.lname.get()), (self.email.get()), (self.phnno.get()),
                                   (self.pass2.get())])
                db.commit()
                db.close()
    ...
    def sendmail(self):
        self.otp = str(randint(0, 9)) + str(randint(0, 9)) + str(randint(0, 9)) + str(randint(0, 9)) + str(
    ...
    def fpo(self):
        ...
        if p == None:
            ...
            a, b = p
            self.otp2 = str(randint(0, 9)) + str(randint(0, 9)) + str(randint(0, 9)) + str(randint(0, 9)) + str(
                randint(0, 9)) + str(randint(0, 9))
            from sendmail import fun
    ...
    def widgets(self):
        ...
        Button(self.rf, text='Create Account', bd=3, font=('', 15), padx=5, pady=5, command=self.new_user).grid(row=4,
                                                                                                                column=1,
                                                                                                                sticky=E)
        self.rf1()
        ...
        Button(self.of, text='Resend OTP', bd=3, font=('', 15), padx=5, pady=5,
               command=self.fpo).grid()  # sendmail fun should be there if we come from 1st otp
        Button(self.of, text='Next', bd=3, font=('', 15), padx=5, pady=5,
               command=lambda: self.chkotp(self.eotp.get(), self.otp, self.of)).grid(row=2, column=1, sticky=E)
        ...
        Button(self.ofc, text='Resend OTP', bd=3, font=('', 15), padx=5, pady=5,
               command=self.sendmail).grid()  # sendmail fun should be there if we come from 1st otp
        Button(self.ofc, text='Next', bd=3, font=('', 15), padx=5, pady=5,
               command=lambda: self.chkotp(self.eotp.get(), self.otp, self.of)).grid(row=2, column=1, sticky=E)
        ...
        Button(self.pf, text='Go to Signup', bd=3, font=('', 15), padx=5, pady=5,
               command=lambda: self.rf1(self.lf)).grid()
        p = Button(self.pf, text='Next', bd=3, font=('', 15), padx=5, pady=5, command=self.saveindb).grid(row=2,
                                                                                                          column=1,
                                                                                                          sticky=E)
        ...
        Button(self.lf, text='Go to Signup', bd=3, font=('', 15), padx=5, pady=5,
               command=lambda: self.rf1(self.lf)).grid(sticky=W)
        Button(self.lf, text='Forgot pass ?', bd=3, font=('', 15), padx=5, pady=5, command=self.fpf).grid(row=2,
                                                                                                          column=1,
                                                                                                          sticky=W)

        Button(self.lf, text='Next', bd=3, font=('', 15), padx=5, pady=5, command=self.logged_in).grid(row=2, column=2,
                                                                                                       sticky=W)
        ...
        Button(self.fp, text='Go to Signup', bd=3, font=('', 15), padx=5, pady=5,
               command=lambda: self.rf1(self.fp)).grid(sticky=W)
        Button(self.fp, text='Next', bd=3, font=('', 15), padx=5, pady=5, command=self.fpo).grid(row=1, column=1,
                                                                                                 sticky=E)
        ...
        Button(self.fof, text='Resend OTP', bd=3, font=('', 15), padx=5, pady=5,
               command=self.fpo).grid()  # change command
        Button(self.fof, text='Next', bd=3, font=('', 15), padx=5, pady=5,
               command=lambda: self.chkotp(self.fotp.get(), self.otp2, self.fof)).grid(row=2, column=1, sticky=E)
